...
--
-- TODO: Options to add
-- Run in coroutine? (would rely on returning as a function)
-- Timeout... perhaps the means to specify coroutine
-- Return as function (for calling via Node, say)
-- Pipe or open file (alternative to coroutine, just set some bytes in a file being read and written simultaneously)
-- Socket (another idea, sort of outside my skill set)
-- Use lfs if present?
-- Ignore files (does it even make sense?)
-- Store lengths somewhere
-- Read lengths somewhere
--
--
